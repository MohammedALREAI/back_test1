...
exports.resolvers = {
    ...
    Query: {
        products: (_root) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const allProduct = yield ProductVapis_1.ProductVariantModel.find({}).populate('product');
                if (!allProduct) {
                    return null;
                }
                return allProduct;
    ...
    ProductVariant: {
        ...
        product: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            const re = yield product_1.Product.findOne({ id: parent.product }).populate('product');
            if (!re) {
                return null;
            }
            return re;
